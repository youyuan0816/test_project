...
def create_google_home_test_cases():
    ...
    wb.save(os.path.join(os.path.dirname(os.path.dirname(__file__)), "test_cases/google/google_home_test_cases.xlsx"))
    print("测试用例已生成到: test_cases/google/google_home_test_cases.xlsx")

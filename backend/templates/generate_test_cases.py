...
test_cases = [
    ["TC-001", "Example页面加载验证", "页面功能", "P0", "网络连接正常", "1. 打开浏览器\n2. 访问 https://example.com\n3. 等待页面加载完成", "页面正常加载，显示内容"],
    ["TC-002", "Example页面标题验证", "页面功能", "P0", "已访问页面", "1. 访问 https://example.com\n2. 获取页面标题", "页面标题正确显示"],
    ["TC-003", "Example页面内容验证", "页面功能", "P0", "已打开页面", "1. 访问 https://example.com\n2. 检查页面主体内容", "页面主体内容正常显示"],
    ["TC-004", "Example页面图片验证", "页面功能", "P1", "已打开页面", "1. 访问 https://example.com\n2. 检查页面中的图片", "图片正常加载显示"],
    ["TC-005", "Example页面链接验证", "页面功能", "P1", "已打开页面", "1. 访问 https://example.com\n2. 检查页面中的链接", "链接正常显示且可点击"],
    ["TC-006", "Example页面响应时间", "页面功能", "P2", "网络连接正常", "1. 记录开始时间\n2. 访问 https://example.com\n3. 记录页面加载完成时间", "页面加载时间在合理范围内"],
    ["TC-007", "Example页面兼容性", "页面功能", "P2", "网络连接正常", "1. 使用不同浏览器访问\n2. 检查页面显示", "各浏览器页面显示正常"],
]
...
wb.save("test.xlsx")
print("Excel 文件已生成: test_cases/demo.xlsx")

...
test_cases = [
    ...
    ["TC-002", "页面标题验证", "页面功能", "P0", "已访问页面", "1. 访问 test\n2. 获取页面标题", "页面标题正确显示"],
    ["TC-003", "页面内容验证", "页面功能", "P0", "已打开页面", "1. 访问 test\n2. 检查页面主体内容", "页面主体内容正常显示"],
    ["TC-004", "页面图片验证", "页面功能", "P1", "已打开页面", "1. 访问 test\n2. 检查页面中的图片", "图片正常加载显示"],
    ["TC-005", "页面链接验证", "页面功能", "P1", "已打开页面", "1. 访问 test\n2. 检查页面中的链接", "链接正常显示且可点击"],
